  ...
  return (
    <div className="container">
      ...
      <section>
        <h2>OVERVIEW</h2>
        <p>
          This website is operated by DivyaGPT. Throughout the site, the terms
          “we”, “us” and “our” refer to DivyaGPT. DivyaGPT offers this website,
      ...
      <section>
        ...
        <p>
          ...
          non-infringement. In no case shall DivyaGPT, our directors, officers,
      ...
      <section>
        ...
        <p>
          You agree to indemnify, defend and hold harmless DivyaGPT and our
      ...
      <section>
        ...
        <p>
          ...
          laws of India and jurisdiction of Lucknow, Uttar Pradesh
        </p>
      </section>
      <section>
